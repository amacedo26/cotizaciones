...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:cot="Cotiza">
  ...
  async function brou() {
    try {
      const lista = await pedir(BROU_URL);
  ...
  return {
    ...
    brou: {
      estado: bk.estado, compra: bk.compra ?? null, venta: bk.venta ?? null,
      promedio: bk.promedio ?? null, fecha: bk.fecha ?? null, error: bk.error ?? null,
      fuente: 'uy.dolarapi.com (espejo de la pizarra del BROU)',
    },
